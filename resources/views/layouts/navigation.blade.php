<div class="nav-inner">
    ...
    <div id="nav-right">
        <a href="{{ route('configuration.index') }}" class="nav-link {{ request()->routeIs('configuration.*') ? 'is-active' : '' }}" aria-label="Configuration" title="Configuration"><i class="fas fa-gear"></i><span>Configuration</span></a>
